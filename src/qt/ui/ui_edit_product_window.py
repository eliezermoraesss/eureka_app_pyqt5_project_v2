...
"}")
        ...
        self.title_label.setGeometry(QtCore.QRect(50, 0, 191, 51))
        font = QtGui.QFont()
...
"}")
        ...
        self.type_label.setGeometry(QtCore.QRect(250, 0, 321, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(-1)
        font.setBold(True)
...
"}")
        ...
        self.logo_enaplic_50.setGeometry(QtCore.QRect(480, 450, 121, 101))
...
"}")
    ...
    def retranslateUi(self, EditProductWindow):
        ...
        self.title_label.setText(_translate("EditProductWindow", "Alterar o produto:"))
