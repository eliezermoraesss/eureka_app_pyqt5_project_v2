...
class Ui_RegisterWindow(object):
    def setupUi(self, RegisterWindow):
        ...
        self.main_area.setGeometry(QtCore.QRect(159, 0, 641, 652))
...
"}")
        ...
        self.user_field.setGeometry(QtCore.QRect(150, 210, 301, 41))
        ...
        self.email_field.setGeometry(QtCore.QRect(150, 290, 301, 41))
        ...
        self.user_label.setGeometry(QtCore.QRect(160, 190, 47, 13))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
        ...
        self.email_label.setGeometry(QtCore.QRect(160, 270, 51, 16))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
        ...
        self.btn_close.setGeometry(QtCore.QRect(310, 530, 91, 41))
...
"}")
        ...
        self.name_label.setGeometry(QtCore.QRect(160, 110, 47, 13))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
        ...
        self.name_field.setGeometry(QtCore.QRect(150, 130, 301, 41))
        ...
        self.password_field.setGeometry(QtCore.QRect(150, 370, 301, 41))
        ...
        self.password_label.setGeometry(QtCore.QRect(160, 350, 51, 16))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
        ...
        self.area_combobox_field.setGeometry(QtCore.QRect(150, 450, 301, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.area_combobox_field.setMaxVisibleItems(20)
        ...
        self.area_lable.setGeometry(QtCore.QRect(160, 430, 51, 16))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
        ...
        self.icon_name_label.setGeometry(QtCore.QRect(100, 130, 32, 32))
        ...
        self.icon_user_label.setGeometry(QtCore.QRect(100, 210, 32, 32))
        ...
        self.icon_email_label.setGeometry(QtCore.QRect(100, 290, 32, 32))
        ...
        self.icon_password_label.setGeometry(QtCore.QRect(100, 370, 32, 32))
        ...
        self.icon_area_label.setGeometry(QtCore.QRect(100, 450, 32, 32))
        ...
        self.logo_enaplic_50.setGeometry(QtCore.QRect(510, 490, 121, 101))
        ...
        self.btn_save.setGeometry(QtCore.QRect(200, 530, 91, 41))
...
"}")
        ...
        self.window_title_label.setGeometry(QtCore.QRect(120, 10, 401, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(1)
        font.setBold(True)
...
"}")
    ...
    def retranslateUi(self, RegisterWindow):
        ...
        self.area_combobox_field.setItemText(4, _translate("RegisterWindow", "Desenvolvimento"))
        self.area_combobox_field.setItemText(5, _translate("RegisterWindow", "Diretoria"))
        self.area_combobox_field.setItemText(6, _translate("RegisterWindow", "Elétrica"))
        self.area_combobox_field.setItemText(7, _translate("RegisterWindow", "Engenharia"))
        self.area_combobox_field.setItemText(8, _translate("RegisterWindow", "Expedição"))
        self.area_combobox_field.setItemText(9, _translate("RegisterWindow", "Financeiro"))
        self.area_combobox_field.setItemText(10, _translate("RegisterWindow", "Fiscal"))
        self.area_combobox_field.setItemText(11, _translate("RegisterWindow", "PCP"))
        self.area_combobox_field.setItemText(12, _translate("RegisterWindow", "Produção"))
        self.area_combobox_field.setItemText(13, _translate("RegisterWindow", "RH"))
