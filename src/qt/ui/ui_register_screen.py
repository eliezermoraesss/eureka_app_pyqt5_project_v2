...
"}")
    ...
    def retranslateUi(self, RegisterWindow):
        ...
        self.area_combobox_field.setItemText(4, _translate("RegisterWindow", "Diretoria"))
        self.area_combobox_field.setItemText(5, _translate("RegisterWindow", "Elétrica"))
        self.area_combobox_field.setItemText(6, _translate("RegisterWindow", "Engenharia"))
        self.area_combobox_field.setItemText(7, _translate("RegisterWindow", "Expedição"))
        self.area_combobox_field.setItemText(8, _translate("RegisterWindow", "Financeiro"))
        self.area_combobox_field.setItemText(9, _translate("RegisterWindow", "Fiscal"))
        self.area_combobox_field.setItemText(10, _translate("RegisterWindow", "PCP"))
        self.area_combobox_field.setItemText(11, _translate("RegisterWindow", "Produção"))
        self.area_combobox_field.setItemText(12, _translate("RegisterWindow", "RH"))
