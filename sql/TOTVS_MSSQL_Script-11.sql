...
SELECT C6_NUM, C6_PRODUTO, C6_DESCRI, C6_XTPOPER 
FROM PROTHEUS12_R27.dbo.SC6010
WHERE C6_NUM LIKE '%7000'
--AND C6_XTPOPER = '2'
ORDER BY R_E_C_N_O_ DESC; -- TABELA ITENS PEDIDO DE VENDA -> C6_XTPOPER = 1 (QP) / 2 (QR) / 3 (ND - SERVIÇO TERCEIRIZADO)
