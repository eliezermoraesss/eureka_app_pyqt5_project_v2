...
WHERE C2_PRODUTO LIKE 'M-034-015-148%'; -- TABELA ORDEM DE PRODUÇÃO
...
SELECT C6_NUM, C6_PRODUTO, C6_DESCRI, C6_XTPOPER FROM PROTHEUS12_R27.dbo.SC6010 ORDER BY R_E_C_N_O_ DESC; -- TABELA ITENS PEDIDO DE VENDA

SELECT * 
FROM PROTHEUS12_R27.dbo.SC6010
--WHERE C6_NUM LIKE '%008084'
...
SELECT COUNT(*) FROM PROTHEUS12_R27.dbo.SD1010 ORDER BY R_E_C_N_O_ DESC; -- TABELA ITENS NF ENTRADA
...
SELECT * FROM PROTHEUS12_R27.dbo.SA2010 ORDER BY R_E_C_N_O_ DESC; -- TABELA FORNECEDORES
